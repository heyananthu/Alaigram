    ...
    return (
        <>
            <div
                ...
                className="group h-[500px] bg-gradient-to-br from-white via-slate-50 to-slate-100 rounded-xl shadow-md overflow-hidden transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl cursor-pointer border border-gray-200"
            >
